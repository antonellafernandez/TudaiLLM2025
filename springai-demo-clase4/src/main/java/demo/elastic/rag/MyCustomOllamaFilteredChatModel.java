...
@Component
public class MyCustomOllamaFilteredChatModel implements ChatModel {
    ...
    public ChatResponse call(Prompt prompt) {
        ...
        // Retorna una respuesta diferente si la respuesta cumple con condiciones inapropiadas definidas
        if (containsInappropriate(response)) {
            Generation generation = new Generation(new AssistantMessage("⚠️ Contenido inapropiado detectado."));
            return new ChatResponse(List.of(generation));
        }

        // Procesa y retorna respuesta si no contiene contenido inapropiado
    ...
    // Contenido definido como inapropiado
    private boolean containsInappropriate(String content) {
