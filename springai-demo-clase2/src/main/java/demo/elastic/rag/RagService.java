...
public class RagService {
    ...
    public String queryLLM(String question) {
	    ...
	    SearchRequest request = SearchRequest.builder().topK(5).similarityThreshold(0.0).query(question).build();
        ...
        String prompt = """
            You're assisting with providing guidelines about LaTex use.
